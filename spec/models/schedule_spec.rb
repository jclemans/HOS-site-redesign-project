...
describe Schedule do
  ...
  #     schedule1 = Schedule.create(:start_time => "5:00", :duration => 90, :program_id => 7, :day_of_week => ["Monday"])
  #     schedule2 = Schedule.new(:start_time => "6:00", :duration => 60, :program_id => 5, :day_of_week => ["Monday"])
  #     schedule2.save.should eq(false)
  #   end

  #   it 'should allow a program schedule to be created if the schedule is available' do
  #     schedule1 = Schedule.create(:start_time => "15:00", :duration => 60, :program_id => 5, :day_of_week => ["Monday"])
  #     schedule2 = Schedule.new(:start_time => "15:00", :duration => 60, :program_id => 5, :day_of_week => ["Wednesday"])
  ...
  #     schedule1 = Schedule.create(:start_time => "23:30", :duration => 120, :program_id => 9, :day_of_week => ["Monday"])
  #     schedule2 = Schedule.new(:start_time => "00:15", :duration => 60, :program_id => 7, :day_of_week => ["Tuesday"])
  #     schedule2.save.should eq(false)
  #   end
  # end
